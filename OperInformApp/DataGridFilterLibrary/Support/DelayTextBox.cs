...
{
    /// <summary>
    /// для плавной и гибкой работы, имитирующей своего рода пошаговый поиск. 
    /// Например, если пользователь вводит буквы «ABC» с интервалами менее 250 миллисекунд, 
    /// выполняется поиск текста ABC, а не 3 поиска A, AB, ABC.
